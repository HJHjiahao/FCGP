...
'''
from G2.modules.sprites.home import Home
from G2.modules.sprites.scenes import Iron, Brick, River, Ice, Tree
from G2.modules.sprites.tanks import PlayerTank, EnemyTank

'''用于运行某一游戏关卡'''
class GameLevel():
	def __init__(self, gamelevel, levelfilepath, sounds, is_dual_mode, cfg, score, prop_use, **kwargs):
		self.score = score
	...
	def __showGamePanel(self, screen, tank_player1, tank_player2=None):
		...
		player2_operate_tip_rect = player2_operate_tip.get_rect()
		player2_operate_tip_rect.left, player2_operate_tip_rect.top = self.width+5, self.height*14/30
		screen.blit(player2_operate_tip, player2_operate_tip_rect)
		# 玩家一状态提示
		...
		player1_state_tip_rect = player1_state_tip.get_rect()
		player1_state_tip_rect.left, player1_state_tip_rect.top = self.width+5, self.height*18/30
		screen.blit(player1_state_tip, player1_state_tip_rect)
		player1_state_tip = self.font.render('TLevel: %s' % tank_player1.tanklevel, True, color_white)
		player1_state_tip_rect = player1_state_tip.get_rect()
		player1_state_tip_rect.left, player1_state_tip_rect.top = self.width+5, self.height*19/30
		screen.blit(player1_state_tip, player1_state_tip_rect)
		# 玩家二状态提示
		...
		player2_state_tip_rect = player2_state_tip.get_rect()
		player2_state_tip_rect.left, player2_state_tip_rect.top = self.width+5, self.height*22/30
		screen.blit(player2_state_tip, player2_state_tip_rect)
		...
		player2_state_tip_rect = player2_state_tip.get_rect()
		player2_state_tip_rect.left, player2_state_tip_rect.top = self.width+5, self.height*23/30
		screen.blit(player2_state_tip, player2_state_tip_rect)
		# 当前关卡
		...
		remaining_enemy_tip_rect.left, remaining_enemy_tip_rect.top = self.width+5, self.height*26/30
		screen.blit(remaining_enemy_tip, remaining_enemy_tip_rect)
		# 得分显示
		score_tip = self.font.render('score: %d' % self.score, True, color_white)
		score_tip_rect = score_tip.get_rect()
		score_tip_rect.left, score_tip_rect.top = self.width+5, self.height*27/30
		screen.blit(score_tip, score_tip_rect)
	'''保护大本营'''
